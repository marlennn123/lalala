...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='car',
            name='car_make',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auction.carmake'),
        ),
        migrations.AddField(
            model_name='carmake',
            name='category',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_review', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='auction.comment')),
            ],
        ),
        migrations.CreateModel(
            name='Model',
            fields=[
                ...
                ('car_make', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auction.carmake')),
            ],
        ),
        migrations.AddField(
            model_name='car',
            name='model',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auction.model'),
        ),
        migrations.CreateModel(
            name='UserProfile',
            fields=[
